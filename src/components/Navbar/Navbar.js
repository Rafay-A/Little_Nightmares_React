    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar style={{ 'paddingLeft': '0px' }}>
          ...
          <Typography style={{ 'backgroundColor':'white', 'color': 'black', 'maxWidth': '330px', 'paddingLeft':'40px', 'marginRight':'40%', 'border': '1px solid black', 'borderLeftStyle': 'none', 'borderRadius': '0px 10px 10px 0px'}} 
